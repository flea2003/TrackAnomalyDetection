...
public class TestShipsDataService {
    ...
    public void setUp() throws Exception {
        signal1 = new AISSignal("hash1", 60.0f, 10.0f,
                20.0f, 60.0f, 80.0f,
                new Timestamp("17/04/2015 20:00"), "Klaipeda");
        signal2 = new AISSignal("hash2", 42.0f, 30.0f,
                20.0f, 60.0f, 80.0f,
                new Timestamp("18/04/2015 20:00"), "Chisinau");
        signal3 = new AISSignal("hash1", 63.0f, 11.0f,
                20.0f, 60.0f, 80.0f,
                new Timestamp("18/04/2015 20:00"), "Amsterdam");
        signal4 = new AISSignal("hash3", 20.0f, 90.0f,
                20.0f, 60.0f, 80.0f,
                new Timestamp("17/04/2015 20:00"), "Delft");
        signal5 = new AISSignal("hash3", 25.0f, 90.0f,
                20.0f, 60.0f, 80.0f,
                new Timestamp("17/04/2015 20:00"), "Zurich");
        signal6 = new AISSignal("hash4", 0.0f, 0.0f,
                20.0f, 60.0f, 80.0f,
                new Timestamp("17/04/2015 20:00"), "Beijing");

        List<ShipInformation> ship1 = List.of(new ShipInformation("hash1", new AnomalyInformation(0.5f, "", new Timestamp("17/04/2015 20:00"), ""), signal1), new ShipInformation("hash3", new AnomalyInformation(0.7f, "", new Timestamp("17/04/2015 20:00"), ""), signal3));

        List<ShipInformation> ship3 = List.of(new ShipInformation("hash3", new AnomalyInformation(0.7f, "", new Timestamp("17/04/2015 20:00"), ""), signal4));


        CurrentShipDetails currentShipDetails1 = new CurrentShipDetails();
        currentShipDetails1.setAnomalyInformation(new AnomalyInformation(0.5f, "", new Timestamp("17/04/2015 20:00"), "hash1"));
        currentShipDetails1.setPastInformation(ship1);

        CurrentShipDetails currentShipDetails2 = new CurrentShipDetails();
        currentShipDetails2.setAnomalyInformation(new AnomalyInformation(0.2f, "", new Timestamp("17/04/2015 20:00"), ""));
        currentShipDetails2.setPastInformation(ship3);

        CurrentShipDetails currentShipDetails3 = new CurrentShipDetails();
        currentShipDetails3.setAnomalyInformation(new AnomalyInformation(0.7f, "", new Timestamp("17/04/2015 20:00"), ""));
        currentShipDetails3.setPastInformation(ship1);

        CurrentShipDetails currentShipDetails4 = new CurrentShipDetails();
        currentShipDetails4.setAnomalyInformation(new AnomalyInformation(0.1f, "", new Timestamp("17/04/2015 20:00"), ""));
