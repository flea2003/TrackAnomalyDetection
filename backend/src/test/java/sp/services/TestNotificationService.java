...
public class TestNotificationService {
    ...
    void setUp() throws NotFoundNotificationException {
        ...
        when(notificationRepository.findByShipHash("hash2")).thenReturn(List.of(notification2, notification3));
        when(notificationRepository.findByShipHash("hash3")).thenReturn(List.of());
    ...
    void testGetAllNotificationsForShip() {
        List<Notification> list = notificationService.getAllNotificationForShip("hash2");
    ...
    void testGetNewestNotificationForShipValid() throws NotFoundNotificationException {
        Notification notification = notificationService.getNewestNotificationForShip("hash2");
    ...
    void testGetNewestNotificationForShipException() throws NotFoundNotificationException {
        assertThrows(NotFoundNotificationException.class, () -> notificationService.getNewestNotificationForShip("hash3"));
    }
}
