...
//
//        assertThrows(RuntimeException.class, () -> aggregator.aggregateSignals(details1, shipInfo2.toJson()));
//    }
//
//    @Test
...
//
//        CurrentShipDetails result = aggregator.aggregateSignals(details1, shipInfo2.toJson());
//
...
//                aggregator.aggregateSignals(details1, shipInfo2.toJson())
//        );
//    }
//
//    @Test
