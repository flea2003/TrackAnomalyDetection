...
class AggregatorTest {
    ...
    @Test
    void aggregateSignalsTestEmptyPastInfo() {
        AnomalyInformation anomalyInfo1 = new AnomalyInformation(0.5f, "", "t1", "ship1");
        CurrentShipDetails details1 = new CurrentShipDetails(anomalyInfo1, null);
    ...
    @Test
    void aggregateSignalsTestUpdatesAisSignal() {
        AnomalyInformation anomalyInfo1 = new AnomalyInformation(0.5f, "", "t1", "ship1");
    ...
    @Test
    void findCorrespondingSignalNotFound() {
        AnomalyInformation anomalyInfo1 = new AnomalyInformation(0.5f, "", "t1", "ship1");
    ...
    @Test
    void aggregateSignalsTestListContainsMore() {
        AnomalyInformation anomalyInfo1 = new AnomalyInformation(0.5f, "", "t1", "ship1");
