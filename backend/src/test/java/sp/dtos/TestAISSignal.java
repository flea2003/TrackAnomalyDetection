...
public class TestAISSignal {
    ...
    String json = "{\"shipHash\":\"ship123\",\"speed\":22.5,\"longitude\":130.0,\"latitude\":45.0,\"course\":180.0,\"heading\":90.0,\"departurePort\":\"New York\",\"timestamp\":\"30/12/2024 04:52\"}";
    AISSignal ais =  new AISSignal("ship123", 22.5f, 130.0f, 45.0f, 180.0f, 90.0f, new Timestamp("30/12/2024 04:52"), "New York");
    ...
    void testGetTimestamp() {
        assertEquals(ais.getTimestamp(), new Timestamp("30/12/2024 04:52"));
    }
