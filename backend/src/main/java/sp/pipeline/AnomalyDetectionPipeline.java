...
public class AnomalyDetectionPipeline {
    ...
    private void buildScoreCalculationPart() {
        ...
        DataStream<AISSignal> source = sourceSerialized.map(AISSignal::fromJson);
    ...
    public CurrentShipDetails aggregateSignals(CurrentShipDetails aggregatedShipDetails, String valueJson, String key)
        ...
        if (aisSignal != null){
            if(aggregatedShipDetails.getCurrentAISSignal() == null
                || aggregatedShipDetails.getCurrentAISSignal().getTimestamp() == null
